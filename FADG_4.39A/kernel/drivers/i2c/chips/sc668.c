...
{	
	...
	{			
		ret = sc668_write_reg(  0x0A, 0x0F);//1.5
	}
	/*
	else if (LogRun == 11)//
	{		
				    ...
				    const struct i2c_device_id *id)
{
	...
	if(ProductID >  Project_DQD  && 
	   ProductID != Project_AI1S && ProductID != Project_AI1D && 
	   ProductID != Project_DMO &&  ProductID != Project_DMT)
	{
