...
static struct usb_gadget_strings adb_string_table_idm = {
	.language =		0x0409,	/* en-us */
	.strings =		string_defs_idm,
};

static struct usb_gadget_strings *adb_strings_idm[] = {
	&adb_string_table_idm,
	NULL,
};
//WilsonWHLee Added interface string --
...
static int adb_bind_config(struct usb_configuration *c)
{
    ...
    if (isMoto)
	    ...
	    dev->function.strings = adb_strings_idm;
//WilsonWHLee Added interface string --	
	/* start disabled */
