...
module_param_named( debug_mask, msm_nand_debug_mask, uint, S_IRUGO | S_IWUSR | S_IWGRP );
...
{
	msm_nand_debug_mask = *(uint32_t*)NAND_DEBUG_MASK_OFFSET; /* FIH, Debbie Sun, 2010/05/24 */
