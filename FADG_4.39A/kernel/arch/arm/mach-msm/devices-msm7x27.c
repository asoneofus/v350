...
/* FIH, KennyChu, 2011/03/21, DMQ.B-1517, add BT deep sleep scheme{ */
#define FIH_GPIO_UART1_RX            (45)
static struct msm_serial_hs_platform_data msm_uart_dm1_pdata = {
        .wakeup_irq = MSM_GPIO_TO_INT(FIH_GPIO_UART1_RX),
...
static struct resource msm_uart2_dm_resources[] = {
	{
		...
		.name  = "uartdm_resource",   //Debbie add, 2010/09/30
		.flags = IORESOURCE_MEM,
	},
	{
...
/* add UART2DM for UART */
#ifdef CONFIG_FIH_FXX
	CLK_PCOM("uartdm_clk",	UART2DM_CLK,	"msm_serial_hsl.0", 0),
#else
