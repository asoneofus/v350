...
int proc_comm_read_adc(unsigned *cmd_parameter);  /* MayLi, adds for reading battery voltage and temperature from PMIC, 2010.10.28 */
...
/* } FIH 2010/12/07, SquareCHFang, NVbackup */
  ...
  SMEM_PROC_COMM_OEM_WRITE_FUSE, //FIH,NeoChen, for read&write FUSE,20100727
  SMEM_PROC_COMM_OEM_READ_FUSE, //FIH,NeoChen, for read&write FUSE,20100727

/* FIH, Debbie, 2011/01/12 { */
  /* add for read/write OTP/UUID */
...
#endif /* _ARCH_ARM_MACH_MSM_MSM_PROC_COMM_H_ */
